...
2. **Propuesta de mejoras**: haga una lluvia de ideas de al menos 6 mejoras y priorice 2-3 con justificación, distinguiendo quick wins de mejoras de mayor impacto o largo plazo. Para cada brecha con más de una solución posible, decida con una **matriz de decisión ponderada** (criterios con pesos definidos por el negocio, puntajes justificados, análisis de sensibilidad y trade-off aceptado; [sección 2.1 de la guía](clase/guia_paso_a_paso_opportunities_solutions.md)).
